            ...
            <div className="">
              {language === "en" && (
                <div>
                  ...
                  <p>
                    In few words, i&apos;m a man who loves to develop high
                    quality web apps. I&apos;m specializing in
                    JavaScript/TypeScript techs, like Reactjs, Nextjs or Nodejs.
                    I also developed projects with Python. I was born in
                    Argentina but i&apos;m italian cittizen and i live in Italy
                    now. I love to learn new things, and if there are about
                    software world, better!
                    <br /> <br />
                    For me, the continue learning is very important. That&apos;s
                    why i&apos;m on the way to become an{" "}
              ...
              {language === "it" && (
                <div className="">
                  ...
                  <p>
                    ...
                    meglio!
                    <br /> <br />
                    Per me il l&apos;apprendimento continuo è molto importante.
                    Ecco perchè sono in il percorso di diventare un{" "}
                    <span className="fw-bold">
